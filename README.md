...
> Answer: The benefits of client-side routing is that you are able to have your SPA loaded into the browsers memory, which means it "loads" pages very fast. It doesn't have to do additional network requests for the components, just the data and then render the components in memory based off of that.
